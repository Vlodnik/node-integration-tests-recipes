...
describe('Recipes', function() {
  ...
  it('should return a JSON response for GET requests', function() {
    (1).should.equal(1);
  ...
  it('should add an item on POST', function() {
    const newRecipe = {name: 'curry', ingredients: ['veggies', 'sauce', 'spices']};
    // it should return JSON data and a 201 status code
    return chai.request(app)
      .post('/recipes')
      .send(newRecipe)
      .then(function(res) {
  ...
  it('should update an item on PUT', function() {
    const updateData = {name: 'thing', ingredients: ['some', 'things']};
    // it should return a status code of 204 after update
    return chai.request(app)
      .get('/recipes')
      .then(function(res) {
        updateData.id = res.body[0].id;
  ...
  it('should delete an item on DELETE', function() {
    // it should return a status code of 204 after deletion
    return chai.request(app)
      .get('/recipes')
      .then(function(res) {
        return chai.request(app)
